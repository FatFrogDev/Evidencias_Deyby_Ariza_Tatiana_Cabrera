        ...
        <nav class="navbar navbar-expand-md bg-light" id="nav" >
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        ...
                        <ul class="navbar-nav d-flex justify-content-center align items-center">
                                ...
                                <li class="nav-item ">
                                        <a class="nav-link active" aria-current="page" href="bolsillo?petition=add_bol_davip" >Crear bolsillo</a>
                                </li>
                        </ul>
                </div>
                </div>
        </nav>
        <center><h1 style="margin-top: 2%; margin-bottom: 2%;">Listado de bolsilos davip</h1></center>
<center>
        <div class="container-md margin-top-5">
                <table class="table table-dark table-davip">
        ...
        <form method="POST" action="bolsillo">
                <tr>
                        ...
                        <td >
                            <center>
                                <button type="submit" name="petition" value="editarBolDavip" style="
