...
<form action="usuario" method="post"  onsubmit="return validarCrearUsuario();">
  <div class="container-sm d-flex container-login container-login-2" style="background-color:  #000000 !important">
      <div class=" container-fluid container-login-title">Iniciar sesión</div>
          <div class="container-login-content">
              ...
              <button type="submit" name="petition" value="loginDavip" class="button-login" >Ingresa</button>
              <!-- <button class="button-login davip-btn"> -->
                <!-- <a href="usuario?petition=dashboard_davip" class="a"> -->
                  Inicia sesión
                <!-- </a>   -->
              </button>
