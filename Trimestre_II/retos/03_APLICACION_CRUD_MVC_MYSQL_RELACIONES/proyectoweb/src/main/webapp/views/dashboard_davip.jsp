...
<div class="container-fluid">
    <button class="navbar-toggler" id="collapse-btn" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav d-flex justify-content-center align items-center">
            ...
            <li class="nav-item ">
                <a class="nav-link active" href="bolsillo?petition=listar_bol_davip">Ver/editar bolsillos</a>
            </li>
            <!--  -->
        </ul>
    </div>
    ...
    <div class="row">
        <div class="col-lg card-col">
            <div class="card align-items-center justify-content-center align-items-center">
                <h5 class="card-title" style="color: #000000 !important;">Consulta tu saldo</h5>
                <div class="card-body">
        ...
        <div class="col-lg card-col">
            <div class="card align-items-center justify-content-center align-items-center">
                <h5 class="card-title" style="color: #000000 !important;">Retira dinero</h5>
                <div class="card-body">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="bolsillo" method="POST">
                                        ...
                                        <input type="number" name="idUsuario" hidden value="<%=(String)session.getAttribute("IdUsuarioDavip")%>">
                                    ...
                                    <div class="row">
                                        <button type="submit" name="petition" value="retiroDavip">Aceptar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-lg card-col">
            <div class="card align-items-center justify-content-center align-items-center" style="margin-top: 2%;">
                <h5 class="card-title" style="color: #000000 !important;">Recarga tu bolsillo</h5>
                <div class="card-body">
                    ...
                    <!-- VENTANA MODAL RETIRO SALDO -->
                            ...
                            <div class="modal fade" id="exampleModal-3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                    <div class="row">
                                        <button type="submit" name="petition" value="recargaDavip">Aceptar</button>
                                        </form>
                                    </div>
                                    </div>
                                </div>
