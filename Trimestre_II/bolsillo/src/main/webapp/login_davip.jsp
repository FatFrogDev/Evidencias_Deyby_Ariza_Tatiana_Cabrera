  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav d-flex justify-content-center align items-center">
            ...
            <li class="nav-item ">
              <a class="nav-link active" aria-current="page" href="route?vista=signup_davip" >Regístrate</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <form action="route" method="post">
      <div class="container-sm d-flex container-login container-login-2">
        <div class=" container-fluid container-login-title">
          Inicio sesión Davi plata
        </div>
          <div class="container-login-content">
            ...
            <button type="submit" name="accion" value="validar_login_davip"class="button-login">Ingresa</button>
            <p class="container-login-p">¿No tienes cuenta?</p>
            <a href="route?vista=signup_davip" class="a">Regístrate</a>
          </div>
      </div>
    </form>
